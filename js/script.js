$(document).ready(function() {
    ...
    function restructure() {
        ...
        setTimeout(function() {
            ...
            $('#content').append("<div class=\"col-9\"><div class=\"card shadow\" style=\"width: 60%;\"><p align=\"center\">Email address (where we'll send your stuff):</p><input type=\"text\" placeholder=\"name@example.com\"><p align=\"center\">Coke or Pepsi? (this will impact fulfillment time):</p><select style=\"position: relative; left: 50%; transform: translateX(-50%)\"><option>Coke</option><option>Pepsi</option></select><textarea placeholder=\"Any additional comments or instructions concerning your request?\"></textarea><input onclick=\"window.location=\'results.html\';\" type=\"submit\" value=\"Submit\"></div></div>")
            $('body').append("<div id=\"footer\"><div class=\"container\"><p>Copyright &copy; 2017 Unstumped Labs. All rights reserved. GNU General Public License.</p></div></div>")
